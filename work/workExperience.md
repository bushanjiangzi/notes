...
**职责**
    ...
    - 从事公司微信公众号前端开发，主要有在线预约医生、费用支付、行业资讯和视频通话功能。
...
2. 奇 π 物联网云平台
   ...
   - 技术要点：
     ...
     6. 每个子系统都内嵌有 ifram 用于展示 2.5D 图，可查看设备状态和控制设备，通过 postMessage 进行通信（定制化开发）。
...
**职责**
    ...
    - 负责公司前端项目开发和文档编写，参与或负责开发的项目有华链智慧 APP，公司官网，Insight 可视化编辑器。
